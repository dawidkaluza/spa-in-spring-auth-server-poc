...
/**
 * Strategy that depending on Content-Type header will perform redirect in different way.
 * If restful redirect is preferred: send response with status code 200 OK and response body
 * containing url where user is supposed to be redirected to.
 * Otherwise, redirect with 302 Found and url placed in Location header.
 */
@Component
